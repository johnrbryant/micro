...
test_that("test-microsim works with valid inputs - no iterations", {
    ...
    mortality_rates <- array(runif(240, max = c(0.05, 0.1, 0.1, 0.3)),
                             ...
                             dimnames = list(age = c("0-4", "5-9", "10-14", "15+"),
                                             ...
                                             sim = 1:3))
    ## all components
    ans_obtained <- micro:::micro_bd(initial_popn = initial_popn,
                                     fert_rates = fertility_rates,
                                     mort_rates = mortality_rates,
                                     n_age = 4L,
                                     n_sex = 2L,
                                     n_period = 5L,
                                     n_iter = 3L,
    ...
    dim(ans_obtained[[1]]) <- c(4, 2, 6, 3)
    dim(ans_obtained[[2]]) <- c(4, 2, 2, 5, 3)
    dim(ans_obtained[[3]]) <- c(4, 2, 2, 5, 3)
